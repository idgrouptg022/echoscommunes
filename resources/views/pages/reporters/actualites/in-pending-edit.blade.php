...
@section('content')
    <div class="page__header__container">
        <ol class="page-header-breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('guests:reporters:actualites:in-pending') }}">Actualites en cours</a></li>
    ...
    <div class="page__content__container">
        ...
        <form action="{{ route('guests:reporters:actualites:in-pending-update', $actualite) }}" class="editForm" method="post" enctype="multipart/form-data">
            @csrf
            @method("PATCH")
